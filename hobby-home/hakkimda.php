   ...
   <?php  require_once 'includes/inc-menu.php'; ?>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1> Hakkımda</h1>
                            <span class="subheading">İlayda Tekeli</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <?= htmlspecialchars_decode($row["aciklama"]) ?>  </div> <a href="index.php" class="btn btn-primary rounded-4 w-50"> Anasayfaya Dön</a>
                    </div>
                </div>
