...
<body>
    ...
    if (@$_POST["submit"]) {
        ...
        $sql = "INSERT INTO hakkimizda (aciklama) VALUES (:aciklama)";
        $stmt = $db->prepare($sql);
    ...
    <?php $cek = $db->prepare("SELECT * FROM `hakkimizda` ORDER BY `id` DESC LIMIT 1");
    $cek->execute();
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="anasayfa.php" class="btn btn-outline btn-warning">Geri Dön</a>
                        </div>
