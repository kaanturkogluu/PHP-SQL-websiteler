...
<head>
    ...
    <title>Mesajlar | Yönetim Panel </title>
                                        ...
                                        while ($row = $cek->fetch(PDO::FETCH_ASSOC)) { ?>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a href="mesajlar.php?is=sil&id=<?= $row["id"] ?>" onclick="return confirm('Silme istediğinize Eminmisiniz?')" class="btn btn-danger btn-xs" style="margin-right:15px;">Sil</a>
