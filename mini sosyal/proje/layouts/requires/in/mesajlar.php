                    ...
                    <div class="container py-5">
                        <div class="row">
                            <div class="col-md-6 col-lg-5 col-xl-5 mb-4 mb-md-0">
                                <h5 class="font-weight-bold mb-3 text-center text-white">Kişiler</h5>
                                <div class="card mask-custom">
                                    <div class="card-body" style="overflow-y: scroll; max-height: 75vh; scrollbar-width:thin;">
                            ...
                            <div id="myscrollbar" class="col-md-6 col-lg-7 col-xl-7" style="overflow-y: scroll; max-height: 75vh; scrollbar-width:thin;">
                                <ul class="list-unstyled text-white">
                                    ...
                                    <li class="mb-3">
                                        <div class="form-outline form-white border rounded-3">
                            ...
                            <script>
                                ...
                                document.addEventListener('DOMContentLoaded', function() {
                                    var lastChild = document.querySelector('.d-flex.justify-content-between.mb-4:last-child');
                                    var lastChildLastElement = lastChild.lastElementChild;

                                    lastChildLastElement.focus();
                                });
                            </script>
                        </div>
                    </div>
